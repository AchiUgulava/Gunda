  ...
  <style> 
          ...
          <div class="imageSwiper">
            <div class=" swiper-wrapper">
              ...
              <div class="bg-fixed swiper-slide">
                  <img src="/images/{{ $slider->image }}" class="z-0 w-full " alt="gunda news img" >
              </div>
              @endforeach
            </div>
    ...
    <section class="text-gray-600 body-font">
      ...
      <div class="py-4 bg-white ">
        <h2 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800">{{ $category->name }}</h2>
          <div class="w-full mb-4">
      ...
      <section class="text-gray-600 bg-white border-b body-font">
        <div class="swiper productSwiper">
          ...
          <div class="swiper-wrapper">
            <!-- Slides -->
            @foreach ($products->wherein('type_id', $types->where('categories_id', $category->id)->pluck('id')->toArray()) as $product)
